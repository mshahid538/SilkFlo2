...
* GetClients()
  Two overrides to get a list of alternative parent clients.* GetTeams()
...
{
    public partial class Department : Abstract
    {
        private SilkFlo.Data.Core.Domain.Business.Department _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public Department ()
        {
            _core = new SilkFlo.Data.Core.Domain.Business.Department();
        }
        public Department(SilkFlo.Data.Core.Domain.Business.Department core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Business.Department cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Business.Department GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Business.Department core)
        {
            _core = core;
        }
        ...
        public static List<Models.Business.Department> Create(IEnumerable<Data.Core.Domain.Business.Department> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Business.Department
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Business.Department(core)));
                return models;
            }

            return cores.Select(core => new Models.Business.Department(core)).ToList();
        }

        public static Models.Business.Department[] Create(Data.Core.Domain.Business.Department[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Business.Department(core)).ToArray();
        }
    }
}