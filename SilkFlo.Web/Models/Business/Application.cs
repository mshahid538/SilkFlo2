...
* GetClients()
  Two overrides to get a list of alternative parent clients.* GetVersions()
...
{
    public partial class Application : Abstract
    {
        private SilkFlo.Data.Core.Domain.Business.Application _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public Application ()
        {
            _core = new SilkFlo.Data.Core.Domain.Business.Application();
        }
        public Application(SilkFlo.Data.Core.Domain.Business.Application core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Business.Application cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Business.Application GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Business.Application core)
        {
            _core = core;
        }
        ...
        public static List<Models.Business.Application> Create(IEnumerable<Data.Core.Domain.Business.Application> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                var models = new List<Models.Business.Application>();
                models.Add(new Models.Business.Application
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Business.Application(core)));
                return models;
            }

            return cores.Select(core => new Models.Business.Application(core)).ToList();
        }

        public static Models.Business.Application[] Create(Data.Core.Domain.Business.Application[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Business.Application(core)).ToArray();
        }
    }
}