...
{
    public partial class HotSpot : Abstract
    {
        private SilkFlo.Data.Core.Domain.Application.HotSpot _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public HotSpot ()
        {
            _core = new SilkFlo.Data.Core.Domain.Application.HotSpot();
        }
        public HotSpot(SilkFlo.Data.Core.Domain.Application.HotSpot core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Application.HotSpot cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Application.HotSpot GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Application.HotSpot core)
        {
            _core = core;
        }
        ...
        [Required]
        [StringLength(20,
                      ErrorMessage = "Width must be between 1 and 20 characters in length.")]
        [DisplayName("Width")]
        public string Width
        {
            get => _core.Width;
        ...
        public string Width_ErrorMessage { get; set; } = "Required";
        public bool Width_IsInValid { get; set; }
        #endregion
        ...
        public static List<Models.Application.HotSpot> Create(IEnumerable<Data.Core.Domain.Application.HotSpot> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Application.HotSpot
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Application.HotSpot(core)));
                return models;
            }

            return cores.Select(core => new Models.Application.HotSpot(core)).ToList();
        }

        public static Models.Application.HotSpot[] Create(Data.Core.Domain.Application.HotSpot[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Application.HotSpot(core)).ToArray();
        }
    }
}