...
{
    public partial class JobLevel : Abstract
    {
        private SilkFlo.Data.Core.Domain.CRM.JobLevel _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public JobLevel ()
        {
            _core = new SilkFlo.Data.Core.Domain.CRM.JobLevel();
        }
        public JobLevel(SilkFlo.Data.Core.Domain.CRM.JobLevel core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.CRM.JobLevel cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.CRM.JobLevel GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.CRM.JobLevel core)
        {
            _core = core;
        }
        ...
        private List<Models.CRM.Prospect> _teamMembers; 
        public List<Models.CRM.Prospect> TeamMembers 
        {
            get
            {
                ...
                _teamMembers = new List<CRM.Prospect>();

                if (_core.TeamMembers == null)
                    return _teamMembers;

                foreach (var core in _core.TeamMembers)
                    _teamMembers.Add(new Models.CRM.Prospect(core));
        ...
        public static List<Models.CRM.JobLevel> Create(IEnumerable<Data.Core.Domain.CRM.JobLevel> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.CRM.JobLevel
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.CRM.JobLevel(core)));
                return models;
            }

            return cores.Select(core => new Models.CRM.JobLevel(core)).ToList();
        }

        public static Models.CRM.JobLevel[] Create(Data.Core.Domain.CRM.JobLevel[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.CRM.JobLevel(core)).ToArray();
        }
    }
}