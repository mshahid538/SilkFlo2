...
{
    public partial class DecisionCount : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.DecisionCount _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public DecisionCount ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.DecisionCount();
        }
        public DecisionCount(SilkFlo.Data.Core.Domain.Shared.DecisionCount core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.DecisionCount cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.DecisionCount GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.DecisionCount core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.DecisionCount> Create(IEnumerable<Data.Core.Domain.Shared.DecisionCount> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.DecisionCount
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.DecisionCount(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.DecisionCount(core)).ToList();
        }

        public static Models.Shared.DecisionCount[] Create(Data.Core.Domain.Shared.DecisionCount[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.DecisionCount(core)).ToArray();
        }
    }
}