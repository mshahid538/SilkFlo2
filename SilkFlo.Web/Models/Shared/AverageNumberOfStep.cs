...
{
    public partial class AverageNumberOfStep : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.AverageNumberOfStep _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public AverageNumberOfStep ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.AverageNumberOfStep();
        }
        public AverageNumberOfStep(SilkFlo.Data.Core.Domain.Shared.AverageNumberOfStep core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.AverageNumberOfStep cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.AverageNumberOfStep GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.AverageNumberOfStep core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.AverageNumberOfStep> Create(IEnumerable<Data.Core.Domain.Shared.AverageNumberOfStep> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.AverageNumberOfStep
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.AverageNumberOfStep(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.AverageNumberOfStep(core)).ToList();
        }

        public static Models.Shared.AverageNumberOfStep[] Create(Data.Core.Domain.Shared.AverageNumberOfStep[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.AverageNumberOfStep(core)).ToArray();
        }
    }
}