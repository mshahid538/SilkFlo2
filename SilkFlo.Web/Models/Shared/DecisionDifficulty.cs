...
{
    public partial class DecisionDifficulty : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.DecisionDifficulty _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public DecisionDifficulty ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.DecisionDifficulty();
        }
        public DecisionDifficulty(SilkFlo.Data.Core.Domain.Shared.DecisionDifficulty core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.DecisionDifficulty cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.DecisionDifficulty GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.DecisionDifficulty core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.DecisionDifficulty> Create(IEnumerable<Data.Core.Domain.Shared.DecisionDifficulty> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                var models = new List<Models.Shared.DecisionDifficulty>();
                models.Add(new Models.Shared.DecisionDifficulty
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.DecisionDifficulty(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.DecisionDifficulty(core)).ToList();
        }

        public static Models.Shared.DecisionDifficulty[] Create(Data.Core.Domain.Shared.DecisionDifficulty[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.DecisionDifficulty(core)).ToArray();
        }
    }
}