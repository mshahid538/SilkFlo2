...
{
    public partial class DocumentationPresent : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.DocumentationPresent _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public DocumentationPresent ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.DocumentationPresent();
        }
        public DocumentationPresent(SilkFlo.Data.Core.Domain.Shared.DocumentationPresent core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.DocumentationPresent cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.DocumentationPresent GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.DocumentationPresent core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.DocumentationPresent> Create(IEnumerable<Data.Core.Domain.Shared.DocumentationPresent> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.DocumentationPresent
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.DocumentationPresent(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.DocumentationPresent(core)).ToList();
        }

        public static Models.Shared.DocumentationPresent[] Create(Data.Core.Domain.Shared.DocumentationPresent[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.DocumentationPresent(core)).ToArray();
        }
    }
}