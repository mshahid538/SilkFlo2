...
{
    public partial class DataInputPercentOfStructured : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.DataInputPercentOfStructured _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public DataInputPercentOfStructured ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.DataInputPercentOfStructured();
        }
        public DataInputPercentOfStructured(SilkFlo.Data.Core.Domain.Shared.DataInputPercentOfStructured core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.DataInputPercentOfStructured cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.DataInputPercentOfStructured GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.DataInputPercentOfStructured core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.DataInputPercentOfStructured> Create(IEnumerable<Data.Core.Domain.Shared.DataInputPercentOfStructured> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.DataInputPercentOfStructured
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.DataInputPercentOfStructured(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.DataInputPercentOfStructured(core)).ToList();
        }

        public static Models.Shared.DataInputPercentOfStructured[] Create(Data.Core.Domain.Shared.DataInputPercentOfStructured[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.DataInputPercentOfStructured(core)).ToArray();
        }
    }
}