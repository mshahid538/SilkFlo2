...
{
    public partial class CostType : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.CostType _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public CostType ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.CostType();
        }
        public CostType(SilkFlo.Data.Core.Domain.Shared.CostType core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.CostType cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.CostType GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.CostType core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.CostType> Create(IEnumerable<Data.Core.Domain.Shared.CostType> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.CostType
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.CostType(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.CostType(core)).ToList();
        }

        public static Models.Shared.CostType[] Create(Data.Core.Domain.Shared.CostType[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.CostType(core)).ToArray();
        }
    }
}