...
{
    public partial class SubmissionPath : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.SubmissionPath _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public SubmissionPath ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.SubmissionPath();
        }
        public SubmissionPath(SilkFlo.Data.Core.Domain.Shared.SubmissionPath core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.SubmissionPath cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.SubmissionPath GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.SubmissionPath core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.SubmissionPath> Create(IEnumerable<Data.Core.Domain.Shared.SubmissionPath> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.SubmissionPath
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.SubmissionPath(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.SubmissionPath(core)).ToList();
        }

        public static Models.Shared.SubmissionPath[] Create(Data.Core.Domain.Shared.SubmissionPath[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.SubmissionPath(core)).ToArray();
        }
    }
}