...
{
    public partial class Rule : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.Rule _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public Rule ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.Rule();
        }
        public Rule(SilkFlo.Data.Core.Domain.Shared.Rule core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.Rule cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.Rule GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.Rule core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.Rule> Create(IEnumerable<Data.Core.Domain.Shared.Rule> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.Rule
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.Rule(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.Rule(core)).ToList();
        }

        public static Models.Shared.Rule[] Create(Data.Core.Domain.Shared.Rule[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.Rule(core)).ToArray();
        }
    }
}