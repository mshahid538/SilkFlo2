...
{
    public partial class AutomationGoal : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.AutomationGoal _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public AutomationGoal ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.AutomationGoal();
        }
        public AutomationGoal(SilkFlo.Data.Core.Domain.Shared.AutomationGoal core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.AutomationGoal cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.AutomationGoal GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.AutomationGoal core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.AutomationGoal> Create(IEnumerable<Data.Core.Domain.Shared.AutomationGoal> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.AutomationGoal
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.AutomationGoal(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.AutomationGoal(core)).ToList();
        }

        public static Models.Shared.AutomationGoal[] Create(Data.Core.Domain.Shared.AutomationGoal[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.AutomationGoal(core)).ToArray();
        }
    }
}