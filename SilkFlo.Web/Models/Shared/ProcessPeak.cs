...
{
    public partial class ProcessPeak : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.ProcessPeak _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public ProcessPeak ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.ProcessPeak();
        }
        public ProcessPeak(SilkFlo.Data.Core.Domain.Shared.ProcessPeak core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.ProcessPeak cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.ProcessPeak GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.ProcessPeak core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.ProcessPeak> Create(IEnumerable<Data.Core.Domain.Shared.ProcessPeak> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.ProcessPeak
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.ProcessPeak(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.ProcessPeak(core)).ToList();
        }

        public static Models.Shared.ProcessPeak[] Create(Data.Core.Domain.Shared.ProcessPeak[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.ProcessPeak(core)).ToArray();
        }
    }
}