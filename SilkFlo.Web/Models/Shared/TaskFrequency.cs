...
{
    public partial class TaskFrequency : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.TaskFrequency _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public TaskFrequency ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.TaskFrequency();
        }
        public TaskFrequency(SilkFlo.Data.Core.Domain.Shared.TaskFrequency core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.TaskFrequency cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.TaskFrequency GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.TaskFrequency core)
        {
            _core = core;
        }
        ...
        public string Hour_ErrorMessage { get; set; } = "Required";
        public bool Hour_IsInValid { get; set; }
        #endregion
        ...
        public static List<Models.Shared.TaskFrequency> Create(IEnumerable<Data.Core.Domain.Shared.TaskFrequency> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.TaskFrequency
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.TaskFrequency(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.TaskFrequency(core)).ToList();
        }

        public static Models.Shared.TaskFrequency[] Create(Data.Core.Domain.Shared.TaskFrequency[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.TaskFrequency(core)).ToArray();
        }
    }
}