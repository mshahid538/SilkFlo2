...
{
    public partial class InputDataStructure : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.InputDataStructure _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public InputDataStructure ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.InputDataStructure();
        }
        public InputDataStructure(SilkFlo.Data.Core.Domain.Shared.InputDataStructure core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.InputDataStructure cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.InputDataStructure GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.InputDataStructure core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.InputDataStructure> Create(IEnumerable<Data.Core.Domain.Shared.InputDataStructure> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.InputDataStructure
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.InputDataStructure(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.InputDataStructure(core)).ToList();
        }

        public static Models.Shared.InputDataStructure[] Create(Data.Core.Domain.Shared.InputDataStructure[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.InputDataStructure(core)).ToArray();
        }
    }
}