...
{
    public partial class NumberOfWaysToCompleteProcess : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.NumberOfWaysToCompleteProcess _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public NumberOfWaysToCompleteProcess ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.NumberOfWaysToCompleteProcess();
        }
        public NumberOfWaysToCompleteProcess(SilkFlo.Data.Core.Domain.Shared.NumberOfWaysToCompleteProcess core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.NumberOfWaysToCompleteProcess cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.NumberOfWaysToCompleteProcess GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.NumberOfWaysToCompleteProcess core)
        {
            _core = core;
        }
        ...
        [Required]
        [StringLength(10,
                      ErrorMessage = "Short Name must be between 1 and 10 characters in length.")]
        ...
        public string ShortName
        {
            ...
            set
            {
                if (_core.ShortName == value)
                    return;

                _core.ShortName = value;
            }
        }

        public string ShortName_ErrorMessage { get; set; } = "Required";
        public bool ShortName_IsInValid { get; set; }
        #endregion
        ...
        public static List<Models.Shared.NumberOfWaysToCompleteProcess> Create(IEnumerable<Data.Core.Domain.Shared.NumberOfWaysToCompleteProcess> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.NumberOfWaysToCompleteProcess
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.NumberOfWaysToCompleteProcess(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.NumberOfWaysToCompleteProcess(core)).ToList();
        }

        public static Models.Shared.NumberOfWaysToCompleteProcess[] Create(Data.Core.Domain.Shared.NumberOfWaysToCompleteProcess[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.NumberOfWaysToCompleteProcess(core)).ToArray();
        }
    }
}