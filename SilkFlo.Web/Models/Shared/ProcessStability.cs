...
{
    public partial class ProcessStability : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.ProcessStability _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public ProcessStability ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.ProcessStability();
        }
        public ProcessStability(SilkFlo.Data.Core.Domain.Shared.ProcessStability core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.ProcessStability cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.ProcessStability GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.ProcessStability core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.ProcessStability> Create(IEnumerable<Data.Core.Domain.Shared.ProcessStability> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.ProcessStability
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.ProcessStability(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.ProcessStability(core)).ToList();
        }

        public static Models.Shared.ProcessStability[] Create(Data.Core.Domain.Shared.ProcessStability[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.ProcessStability(core)).ToArray();
        }
    }
}