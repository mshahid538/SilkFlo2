...
{
    public partial class ApplicationStability : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.ApplicationStability _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public ApplicationStability ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.ApplicationStability();
        }
        public ApplicationStability(SilkFlo.Data.Core.Domain.Shared.ApplicationStability core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.ApplicationStability cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.ApplicationStability GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.ApplicationStability core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.ApplicationStability> Create(IEnumerable<Data.Core.Domain.Shared.ApplicationStability> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.ApplicationStability
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.ApplicationStability(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.ApplicationStability(core)).ToList();
        }

        public static Models.Shared.ApplicationStability[] Create(Data.Core.Domain.Shared.ApplicationStability[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.ApplicationStability(core)).ToArray();
        }
    }
}