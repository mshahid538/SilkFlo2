...
{
    public partial class Achievement : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.Achievement _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public Achievement ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.Achievement();
        }
        public Achievement(SilkFlo.Data.Core.Domain.Shared.Achievement core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.Achievement cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.Achievement GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.Achievement core)
        {
            _core = core;
        }
        ...
        public List<Models.Selector> AllUsers_For_UserAchievements { get; set; } = new List<Models.Selector>();
        ...
        public static List<Models.Shared.Achievement> Create(IEnumerable<Data.Core.Domain.Shared.Achievement> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.Achievement
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.Achievement(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.Achievement(core)).ToList();
        }

        public static Models.Shared.Achievement[] Create(Data.Core.Domain.Shared.Achievement[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.Achievement(core)).ToArray();
        }
    }
}