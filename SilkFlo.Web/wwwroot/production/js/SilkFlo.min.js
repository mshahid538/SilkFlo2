...
height: 527px;">
      ...
      </div>`;$(n).appendTo("body");$("#SilkfloWorkshopModal").modal("show")}function showPlatformSetup(){$("#SilkfloWorkshopModal").modal("hide");var n=`
