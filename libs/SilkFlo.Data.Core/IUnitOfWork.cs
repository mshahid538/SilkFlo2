...
namespace SilkFlo.Data.Core
{
  public interface IUnitOfWork : IDisposable
  {
    ...
    void Add(SilkFlo.Data.Core.Domain.Business.Role core);

    Task AddAsync(SilkFlo.Data.Core.Domain.Business.Role core);

    void Add(IEnumerable<SilkFlo.Data.Core.Domain.Business.Role> cores);

    Task AddAsync(IEnumerable<SilkFlo.Data.Core.Domain.Business.Role> cores);

    void GetCreatedUpdated(IEnumerable<SilkFlo.Data.Core.Domain.Business.Role> cores);

    Task GetCreatedUpdatedAsync(IEnumerable<SilkFlo.Data.Core.Domain.Business.Role> cores);

    void GetCreatedUpdated(SilkFlo.Data.Core.Domain.Business.Role core);

    Task GetCreatedUpdatedAsync(SilkFlo.Data.Core.Domain.Business.Role core);
